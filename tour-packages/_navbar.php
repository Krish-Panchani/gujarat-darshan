...
<div class="w-full text-gray-700 bg-white px-2">
    <div x-data="{ open: false }" class="flex flex-col max-w-screen-2xl px-4 mx-auto border-0 rounded-2xl md:border-b-2  border-black my-4 md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
