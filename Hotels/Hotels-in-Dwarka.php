<?php 
$title = "Hotel in Dwarka | Gujarat Darshan";
$desc = "Book the best hotels in Dwarka for a peaceful and spiritual retreat. Enjoy comfortable rooms and close proximity to major temples.";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const hotelIn = 'Dwarka'; // Replace with actual value or dynamic input
