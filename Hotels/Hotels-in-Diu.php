<?php 
$title = "Hotel in Diu | Gujarat Darshan";
$desc = "Discover the finest hotels in Diu for a relaxing and enjoyable stay. Explore beachside resorts and charming accommodations. Reserve your stay now.";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const hotelIn = 'Diu'; // Replace with actual value or dynamic input
