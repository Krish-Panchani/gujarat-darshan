<?php 
$title = "Hotel in Gir | Gujarat Darshan";
$desc = "Stay at the top hotels in Gir, close to the Gir National Park. Experience wildlife adventures with comfortable and convenient accommodations.";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const hotelIn = 'Sasan Gir'; // Replace with actual value or dynamic input
