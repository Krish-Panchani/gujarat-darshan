<?php 
$title = "Hotel in Somnath | Gujarat Darshan";
$desc = "Book your stay at the best hotels in Somnath. Enjoy comfort and convenience while exploring the sacred Somnath Temple and nearby attractions.";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const hotelIn = 'Somnath'; // Replace with actual value or dynamic input
